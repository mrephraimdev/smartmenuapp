    ...
    <div class="p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="border border-gray-100 rounded-xl p-4 hover:border-violet-200 hover:shadow-sm transition-all">
            ...
            <div class="grid grid-cols-3 gap-1.5">
                ...
                <a href="{{ route('admin.pos.index', $t->slug) }}" class="flex flex-col items-center p-2 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-600 transition-colors">
                    ...
                    <span class="text-[10px] font-semibold">Caisse</span>
                </a>
