...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between mb-3">
            ...
            <a href="{{ route('superadmin.users.index') }}" class="text-amber-400 hover:text-amber-600 transition-colors">
        ...
        <p class="text-sm text-gray-500 mt-0.5">Admins restaurants</p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:shadow-md transition-shadow">
        <div class="flex items-center justify-between mb-3">
            ...
            <a href="{{ route('superadmin.permissions') }}" class="text-violet-400 hover:text-violet-600 transition-colors">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3"/>
                </svg>
            </a>
        </div>
        <p class="text-2xl font-bold text-gray-900">{{ count(\App\Enums\UserRole::tenantRoles()) }}</p>
        <p class="text-sm text-gray-500 mt-0.5">Rôles configurables</p>
    </div>
</div>
