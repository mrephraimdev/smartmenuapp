...
@section('page-title', 'Nouveau Restaurant')
@section('breadcrumb')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="type" name="type"
                            ...
                            <option value="mariage" {{ old('type') == 'mariage' ? 'selected' : '' }}>Mariage / Evenement</option>
                        </select>
                        @error('type')
                            <p class="mt-1.5 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select id="locale" name="locale"
                                ...
                                required>
                            <option value="fr" {{ old('locale', 'fr') == 'fr' ? 'selected' : '' }}>Francais</option>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-500">
                                    <label for="logo" class="relative cursor-pointer rounded-md font-semibold text-violet-600 hover:text-violet-500 focus-within:outline-none">
                                        <span>Telecharger un fichier</span>
...
@push('scripts')
<script>
    // Generer automatiquement le slug a partir du nom
