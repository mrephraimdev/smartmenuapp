...
<head>
    ...
    <title>Modifier le Tenant - {{ $tenant->name }}</title>
        ...
        <header class="bg-white shadow-sm">
            <div class="container mx-auto px-4 py-4">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-gray-800">Modifier: {{ $tenant->name }}</h1>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    <option value="mariage" {{ old('type', $tenant->type) == 'mariage' ? 'selected' : '' }}>Mariage/Événement</option>
                                </select>
                                @error('type')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mb-3 flex items-center space-x-4">
                                    ...
                                    <div class="text-sm text-gray-500">Logo actuel</div>
                                </div>
                                @endif
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="logo" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                                <span>{{ $tenant->logo_url ? 'Changer le logo' : 'Télécharger un fichier' }}</span>
                            ...
                            <div>
                                ...
                                @if($tenant->cover_url)
                                <div class="mb-3">
                                    <img src="{{ $tenant->cover_url }}" alt="Couverture actuelle" class="w-full h-20 object-cover rounded-lg border-2 border-gray-200">
                                    <div class="text-sm text-gray-500 mt-1">Couverture actuelle</div>
                                </div>
                                @endif
                                    ...
                                    <div class="space-y-1 text-center">
                                        ...
                                        <div class="flex text-sm text-gray-600">
                                            <label for="cover" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none">
                                                <span>{{ $tenant->cover_url ? 'Changer la couverture' : 'Télécharger un fichier' }}</span>
