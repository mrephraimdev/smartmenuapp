...
return [
    ...
    'backup' => [
        ...
        'source' => [
            ...
            'files' => [
                ...
                /*
                 * The strategy that should be used to create checksums.
                 */
                'relative_path' => null,
            ],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('BACKUP_NAME', 'smartmenu-backup'),
         ...
         * You may use names that are supported by ZipArchive, like 'AES-256'.
         *
         * When providing an unsupported string, ZipArchive will silently
         * switch to the default algorithm.
         */
        'encryption' => 'default',
    ],
    ...
    'monitor_backups' => [
        [
            'name' => env('BACKUP_NAME', env('APP_NAME')),
